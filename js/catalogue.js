...
const CATALOGUE_PRODUCTS = [
  ...
  { id: 'rose-sculpture', name: 'Rose Sculpture', description: 'Intricate floral pillar candle (1pc).', category: 'mould', tag: 'Mould', image: 'assets/rosesculpture.jpg', bg: '#f9f9f9' },
  { id: 'strawberry-milk', name: 'Strawberry Milk', description: 'Sweet, creamy blend of fresh strawberries (1pc).', category: 'jar', tag: 'Jar', image: 'assets/strawberrymilk.jpg', bg: '#fff0f3' },
  ...
  { id: 'z-shape', name: 'Z-Shape Aesthetic', description: 'Unique Z-shaped sculptural candle.', category: 'mould', tag: 'Mould', image: 'assets/aurawave.jpg', bg: '#f5f5f5' },
...
window.openEnquiryModal = function(productId) {
  ...
  document.getElementById('modal-product-title').textContent = `Enquiry: ${currentProduct.name}`;
  document.getElementById('enq-message').value = `Hi, I'm interested in a bulk order for ${currentProduct.name}. Please get in touch with me.`;
